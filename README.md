...
```
git clone --depth=1 https://github.com/Xcod3bughunt3r/CloudSploitScans.git
```
...
#### *[Follow](https://github.com/Xcod3bughunt3r/CloudSploitScans/blob/main/Xcod3bughunt3r.md) Me*
